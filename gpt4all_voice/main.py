...
wake_word = "system"
model = GPT4All(
    "C:\\Users\\Matt\\.cache\\gpt4all\\gpt4all-falcon-newbpe-q4_0.gguf", allow_download=True)
r = sr.Recognizer()

tiny_model_path = os.path.expanduser(
    "C:\\Users\\Matt\\.cache\\whisper\\tiny.pt")
base_model_path = os.path.expanduser(
    "C:\\Users\\Matt\\.cache\\whisper\\base.pt")
